...
// =================== 스트레치 렌더 ===================
	...
	//스트레치 함수 (DC, 출력할 X위치, 출력할 Y위치, 출력할 X크기, 출력할 Y크기)
	void stRender(HDC hdc, int destX, int destY, int sourWidth, int sourHeight);
	void stRender(HDC hdc, int destX, int destY, int destWidth, int destHeight, int sourX, int sourY, int sourWidth, int sourHeight);
	void stRatioRender(HDC hdc, int destX, int destY, float Xratio, float Yratio);

	//스트레치 프레임 렌더
	void stFrameRender(HDC hdc, int destX, int destY, int adjWidth, int adjHeight);
	void stFrameRatioRender(HDC hdc, int destX, int destY, int Xratio, int Yratio);
	...
	//알파 스트레치 렌더
	void alphaStRatioRender(HDC hdc, int destX, int destY, float XRatio, float YRatio, BYTE alpha);

	//알파 프레임 렌더
	void alphaFrameRender(HDC hdc, int destX, int destY, BYTE alpha);
	void alphaFrameRender(HDC hdc, int destX, int destY, int currentFrameX, int currentFrameY, BYTE alpha);
	void alphaStFrameRender(HDC hdc, int destX, int destY, BYTE alpha);
